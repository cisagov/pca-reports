...
class PreviewGenerator(object):
    ...
    def __run_queries(self):
        self.__templates = list(TemplateDoc.objects.raw({'_id':{'$in':self.__template_id_list}}).project({'_id':0}).order_by([('complexity', pymongo.ASCENDING), ('name', pymongo.ASCENDING)]))
